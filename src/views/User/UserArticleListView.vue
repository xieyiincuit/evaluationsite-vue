...
export default {
  ...
  methods: {
    ...
    categoryFormatter(row) {
      return this.typeList.find((o) => o.categoryId == row.categoryId)
        .categoryType;
    },
    ...
    getMyArticles() {
      this.$http.get(
        `v1/e/my/articles?pageIndex=${this.paginationInfo.currentPage}`,
        null,
        (res) => {
          ...
          this.$http.get("v1/e/category/list", null, (res) => {
            ...
            this.tableData.forEach((element) => {
              var categoryName = this.typeList.find(
                (o) => o.categoryId == element.categoryId
              ).categoryType;
